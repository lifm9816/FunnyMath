...
public class Trinomial_quiz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        correct = MediaPlayer.create(Trinomial_quiz.this, R.raw.correct);
        wrong = MediaPlayer.create(Trinomial_quiz.this, R.raw.wrong);
    ...
    private void setupRadioGroupListeners() {
        ...
        setupRadioGroupListener(radioGroup1, R.id.answer1a); // Ejemplo: respuesta correcta para radioGroup1 es answer1a
        ...
        setupRadioGroupListener(radioGroup8, R.id.answer8c);
    ...
    private void checkAnswers() {
        ...
        if (radioGroup7.getCheckedRadioButtonId() == R.id.answer7a) score++;
        if (radioGroup8.getCheckedRadioButtonId() == R.id.answer8c) score++;
        if (radioGroup9.getCheckedRadioButtonId() == R.id.answer9a) score++;
        if (radioGroup10.getCheckedRadioButtonId() == R.id.answer10a) score++;

        String quiz = "trinomial_ax2_bx_c"; // Nombre del quiz para identificar en la siguiente actividad
